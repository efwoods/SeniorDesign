...
#ifndef RTW_HEADER_System_h_
#define RTW_HEADER_System_h_
#include <stddef.h>
#include <string.h>
#include "rtw_modelmap.h"
#ifndef System_COMMON_INCLUDES_
# define System_COMMON_INCLUDES_
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_System                 RT_MODEL_System_T

/* Definition for use in the target main file */
#define System_rtModel                 RT_MODEL_System_T
...
typedef struct {
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_d;                 /* '<S1>/S-Function' */
...
#define rtB                            System_B
#define BlockIO                        B_System_T
#define rtY                            System_Y
#define ExternalOutputs                ExtY_System_T
#define rtP                            System_P
#define Parameters                     P_System_T
#define rtDWork                        System_DW
#define D_Work                         DW_System_T
...
struct P_System_T_ {
  ...
  real_T Q4AD_P7;                      /* Expression: pciSlot
                                        * Referenced by: '<Root>/Q4 AD'
                                        */
  real_T Magnet_Control_Value;         /* Expression: 1
...
extern P_System_T System_P;

/* Block signals (auto storage) */
extern B_System_T System_B;

/* Block states (auto storage) */
extern DW_System_T System_DW;

/* External outputs (root outports fed by signals with auto storage) */
extern ExtY_System_T System_Y;

/*====================*
 * External functions *
 *====================*/
extern System_rtModel *System(void);
...
extern const rtwCAPI_ModelMappingStaticInfo*
  System_GetCAPIStaticMap(void);

/* Real-time Model object */
extern RT_MODEL_System_T *const System_M;
 ...
 *
 * '<Root>' : 'System'
 * '<S1>'   : 'System/Magnet Control Scope'
 * '<S2>'   : 'System/Signal From Load Cell into Q4'
 */
#endif                                 /* RTW_HEADER_System_h_ */

...
MODEL           = System
MODULES         = rt_matrx.c rt_printf.c System_capi.c System_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE        = System.mk
...
MODELLIB                  = Systemlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = System_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\System_slrt_rtw

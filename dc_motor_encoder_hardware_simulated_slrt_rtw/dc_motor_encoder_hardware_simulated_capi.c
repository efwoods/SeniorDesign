...
* organizational use. 
  ...
  * C source code generated on : Sun Apr 15 21:14:24 2018
 * 
 ...
 * Validation result: Not run
  ...
  #define TARGET_STRING(s)               (s)
	...
	static const rtwCAPI_Signals rtBlockSignals[] = {
	   ...
	   */
                        ...
                        {14, 0, TARGET_STRING("Real motor/angular_position =  [relative_count//COUNTS_PER_REV] *360 degrees"),
                        TARGET_STRING(""), 0, 0,                         0, 0, 0},
  ...
  static const rtwCAPI_SampleTimeMap rtSampleTimeMap[] = {
	...
	{(const void *) &rtcapiStoredFloats[0], (const void *) &rtcapiStoredFloats[1], 1, 0},
      {(const void *) &rtcapiStoredFloats[1], (const void *) &rtcapiStoredFloats[1], 0, 0}
  };
  ...
  #ifndef HOST_CAPI_BUILD
  void dc_motor_encoder_hardware_simulated_InitializeDataMapInfo(RT_MODEL_dc_motor_encoder_hardware_simulated_T *const dc_motor_encoder_hardware_simulated_M) {
  ...
  rtwCAPI_SetStaticMap(dc_motor_encoder_hardware_simulated_M->DataMapInfo.mmi, &mmiStatic);

  /* Cache static C-API logging data into the Real-time Model Data structure */
  rtwCAPI_SetLoggingStaticMap(dc_motor_encoder_hardware_simulated_M->DataMapInfo.mmi, (NULL));

    /* Cache C-API Data Addresses into the Real-Time Model Data structure */
    rtwCAPI_SetDataAddressMap(dc_motor_encoder_hardware_simulated_M->DataMapInfo.mmi, rtDataAddrMap);

    /* Cache C-API Data Run-Time Dimension Buffer Addresses into the Real-Time Model Data structure */
    rtwCAPI_SetVarDimsAddressMap(dc_motor_encoder_hardware_simulated_M->DataMapInfo.mmi, rtVarDimsAddrMap);    
        /* Cache C-API rtp Address and size  into the Real-Time Model Data structure */      
        dc_motor_encoder_hardware_simulated_M->DataMapInfo.mmi.InstanceMap.rtpAddress =  rtmGetDefaultParam(dc_motor_encoder_hardware_simulated_M);     
        dc_motor_encoder_hardware_simulated_M->DataMapInfo.mmi.staticMap->rtpSize =  sizeof(P_dc_motor_encoder_hardware_simulated_T);

  /* Cache the instance C-API logging pointer */
    rtwCAPI_SetInstanceLoggingInfo(dc_motor_encoder_hardware_simulated_M->DataMapInfo.mmi, (NULL));

  /* Set reference to submodels */
    rtwCAPI_SetChildMMIArray(dc_motor_encoder_hardware_simulated_M->DataMapInfo.mmi, (NULL));
    rtwCAPI_SetChildMMIArrayLen(dc_motor_encoder_hardware_simulated_M->DataMapInfo.mmi, 0);
